 ...
 *
 * За что отвечает:
 * - Баннер с изображением викингов
 * - Приветствие героя (имя + уровень)
 * - Сетка из 12 разделов (Дневник, Задания, Дуэль, Поселок, Поход, Подземелье,
 *   Дракон, Орки, Орден, Дружина, Зверинец, Лучшие)
 * - Блокирует кнопку «Дуэль» во время похода
 * - Нижняя навигация: Главная, Герой, Чат, Почта
 */
