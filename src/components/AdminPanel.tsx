/**
 * AdminPanel.tsx — Панель администратора (скрытая)
 *
 * За что отвечает:
 * - Вход по паролю (токен хранится в sessionStorage)
 * - Список всех игроков с поиском по нику/имени
 * - Редактирование любого параметра игрока: ресурсы, статы, уровень, бои
 * - Сохранение изменений через бэкенд hero-admin
 * - Открывается через 5 кликов по копирайту в GameFooter
 */
